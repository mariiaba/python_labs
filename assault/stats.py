...
class Results:
    ...
    def average_time(self) -> float:
        """
        Returns the awerage request completion time
    ...
    def successful_requests(self) -> int:
        """
        Returns the namber of successful requests
    ...
    def requests_per_minute(self) -> int:
        """
        Returns the namber of requests that could be made in a minute
    ...
    def requests_per_second(self) -> int:
        """
        Returns the namber of requests that could be made in a second
